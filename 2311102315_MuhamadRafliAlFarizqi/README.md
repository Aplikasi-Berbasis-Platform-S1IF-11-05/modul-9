...
![Sebelum klik](screenshot-before.png)

Setelah tombol diklik:

![Setelah klik](screenshot-after.png)

### Penjelasan

Website ini adalah halaman AJAX Profil Viewer yang menampilkan tombol "Tampilkan Profil". Ketika tombol diklik, JavaScript menggunakan `fetch()` untuk mengambil data JSON (nama, pekerjaan, lokasi) dari server PHP (`data.php`) secara asinkron. Data profil ditampilkan di halaman dalam format **Nama: Muhamad Rafli Al Farizqi | Pekerjaan: Mahasiswa | Lokasi: Purwokerto** tanpa perlu me-reload halaman.
